...
# 정보 불러오기
node = pd.read_csv('./data/school_test_erp/node_school.csv', keep_default_na=False)
link = pd.read_csv('./data/school_test_erp/link_school.csv', keep_default_na=False)
tracking = pd.read_csv('./data/school_test_nonmoon/tracking_school2.csv', keep_default_na=False)
    ...
    while openList:
      ...
      if currentNode.name == endNode.name:
        ...
        while current is not None:
          ...
          ## 여기서 for문으로 currnet를 ToNodeID인 라인에 해당하는 노드들을 넣으면 되는데 어케 함 씨발?
...
if __name__ == '__main__':
  ...
  K_city_waypoint = deque([
                           [(node_dict[link_dict['L1'][0]][0], node_dict[link_dict['L1'][0]][1], link_dict['L1'][0]),
                            (node_dict[link_dict['L2'][1]][0], node_dict[link_dict['L2'][1]][1], link_dict['L2'][1])],
                           [(node_dict[link_dict['L3'][0]][0], node_dict[link_dict['L3'][0]][1], link_dict['L3'][0]),
                            (node_dict[link_dict['L8'][1]][0], node_dict[link_dict['L8'][1]][1], link_dict['L8'][1])],
                          ])
  ...
  coordinate_CSV.to_csv("/home/car/gencoupe/src/path_planning/scripts/path.csv")
